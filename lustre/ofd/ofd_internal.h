...
/* ofd_io.c */
int ofd_preprw(int cmd, struct obd_export *exp,
...
int ofd_log_sz_change(struct llog_handle *cathandle,
                         struct ll_fid *mds_fid,
                         __u32 ioepoch,
                         struct llog_cookie *logcookie,
                         struct inode *inode);
void ofd_cancel_cookies_cb(struct obd_device *obd, __u64 transno,
