...
static int lprocfs_osd_rd_blksize(char *page, char **start, off_t off,
...
static int lprocfs_osd_rd_kbytestotal(char *page, char **start, off_t off,
                                      int count, int *eof, void *data)
{
        struct osd_device *osd = data;
        struct obd_statfs osfs;
...
static int lprocfs_osd_rd_kbytesfree(char *page, char **start, off_t off,
                                     int count, int *eof, void *data)
{
        struct osd_device *osd = data;
        struct obd_statfs osfs;
...
static int lprocfs_osd_rd_kbytesavail(char *page, char **start, off_t off,
                                      int count, int *eof, void *data)
{
        struct osd_device *osd = data;
        struct obd_statfs osfs;
...
static int lprocfs_osd_rd_filestotal(char *page, char **start, off_t off,
                                     int count, int *eof, void *data)
{
        struct osd_device *osd = data;
        struct obd_statfs osfs;
...
static int lprocfs_osd_rd_filesfree(char *page, char **start, off_t off,
                                    int count, int *eof, void *data)
{
        struct osd_device *osd = data;
        struct obd_statfs osfs;
