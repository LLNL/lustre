...
#ifdef LIBCFS_DEBUG
#define ldlm_lock_debug(msgdata, level, lock, fmt, a...) do {           \
...
#define LDLM_DEBUG_LIMIT(mask, lock, fmt, a...) do {                    \
        ...
        LIBCFS_DEBUG_MSG_DATA_DECL(msgdata, &_ldlm_cdls);               \
        ldlm_lock_debug(msgdata, mask, lock, "### " fmt , ##a);         \
} while (0)
...
#define LDLM_DEBUG(lock, fmt, a...)   do {                              \
        ...
        ldlm_lock_debug(msgdata, D_DLMTRACE, lock, "### " fmt , ##a);   \
} while (0)
#else /* !LIBCFS_DEBUG */
