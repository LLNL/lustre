...
#define LMD_FLG_MGS          0x0080  /* Also start MGS along with server */
#define LMD_FLG_IAM          0x0100  /* IAM dir */
#define LMD_FLG_NO_PRIMNODE  0x0200  /* all nodes are service nodes */
