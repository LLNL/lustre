...
lnet_handle_send(struct lnet_send_data *sd)
{
	...
	if (sd->sd_cpt != cpt2) {
		...
		if (seq != lnet_get_dlc_seq_locked()) {
			best_lpni->lpni_debug_info[19] += 1;
